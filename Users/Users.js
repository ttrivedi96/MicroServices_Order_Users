...
async function connectMongoose() {
	await mongoose.connect('mongodb://localhost:27017/msUSer', { useNewUrlParser: true, useUnifiedTopology:true }).then(
    () =>{
...
// https://dev.to/rmhetre/how-to-build-a-microservice-with-nodejs-express-and-mongodb-3l5o